...
vim.opt.completeopt = { 'menu', 'menuone', 'longest', 'preview', 'noselect' }
...
vim.notify = function(msg, level, opts)
  if msg and type(msg) == "string" then
    local ignored_messages = {
      ...
      -- Add any other messages you want to ignore here
    }
...
-- Override the deprecated function to suppress the warning
